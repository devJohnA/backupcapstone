                ...
                <div class="main__title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="fs-4">List of Users <a href="index.php?view=add"
                    ...
                    <form action="controller.php?action=delete" Method="POST">
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td align="center" > <a title="Edit" href="index.php?view=edit&id='.$result->USERID.'"  class="btn btn-primary btn-sm  ">  Edit</span></a>

				  					 <a title="Delete" href="controller.php?action=delete&id='.$result->USERID.'" class="btn btn-danger btn-sm">Delete </a>
