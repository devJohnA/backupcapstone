        ...
        <div class="card">
            <div class="card-body">
                <div class="main__title">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="fs-4">List of Location <a href="index.php?view=add"
                    ...
                    <form action="controller.php?action=delete" Method="POST">
						...
						foreach ($cur as $result) { 
				  		...
				  		echo
				  		 '<td align="left">
							<a href="'.web_root.'admin/settings/index.php?view=edit&id='.$result->SETTINGID.'" class="btn btn-primary btn-sm">Edit</a>
                            <a href="'.web_root.'admin/settings/controller.php?action=delete&id='.$result->SETTINGID.'" class="btn btn-danger btn-sm">Delete</a>
						 </td>';
				  	} 
				  	?>
                                </tbody>
