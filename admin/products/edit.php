        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="PROID" name="PROID" type="hidden"
                                    value="<?php echo $singleproduct->PROID; ?>">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control input-sm" id="ORIGINALPRICE" name="ORIGINALPRICE"
                                    placeholder="Original Price" type="number"
                                    value="<?php echo $singleproduct->ORIGINALPRICE; ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control input-sm" id="PROPRICE" name="PROPRICE" placeholder="Price"
                                    type="number" step="any" value="<?php echo $singleproduct->PROPRICE; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            <label class="col-md-4 control-label" for="PROQTY">Stock:</label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <!-- <button class="btn btn-danger btn-sm" name="delete" type="button" onclick="prepareDelete();"><span class="fa fa-trash fw-fa"></span> Delete</button> -->
