...
<section id="features" class="section-three">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Explore our extensive collection of tools, hardware, and accessories
                            designed to tackle any project with ease.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">We pride ourselves on offering high-quality products that are durable and
                            reliable, ensuring your projects are built to last.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Our knowledgeable staff are here to assist you, whether you're a
                            professional contractor or a DIY enthusiast, ensuring you have the support you need.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section id="quote-section" class="section-four">
    <div class="container ">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-7">
                <div class="quote-message">
                    <blockquote>
                        <p style="text-align:justify;"> Welcome to Windale Hardware, your one-stop shop for all your
                            home
                            improvement needs. With
                            years of experience in the industry, we pride ourselves on offering quality tools, hardware,
                            and expert advice to both professionals and DIY enthusiasts alike.</p>
                    </blockquote>
